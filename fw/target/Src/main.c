...
static void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOB,
                      SFP_TX_DIS_Pin | SFP_RS0_Pin | RET_PWR_HEN_Pin | SFP_PWR_HEN_Pin | CHG_ISET_Pin | SFP_RS1_Pin,
                      GPIO_PIN_RESET);
    ...
    GPIO_InitStruct.Pin = SFP_TX_DIS_Pin | SFP_RS0_Pin | RET_PWR_HEN_Pin | SFP_PWR_HEN_Pin | CHG_ISET_Pin | SFP_RS1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
